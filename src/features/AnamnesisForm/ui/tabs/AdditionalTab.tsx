...
export const AdditionalTab: React.FC<TabProps> = ({ register, watch }) => (
  <div className={styles.section}>
    ...
    <Input label="Аппендицит" {...register("additionalHistory.appendicitis")} />
    <Input
      label="Холецистит"
      {...register("additionalHistory.cholecystitis")}
    />
    <Input label="Туберкулёз" {...register("additionalHistory.tuberculosis")} />
